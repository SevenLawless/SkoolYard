...
export default function EditPaymentPage() {
  const { data, updatePayment } = useData();
  ...
  if (!payment) {
    return (
      <div className="space-y-6">
        <Breadcrumbs items={[{ href: "/dashboard", label: "Dashboard" }, { href: "/payments", label: "Payments" }, { label: "Edit" }]} />
    ...
    <div className="max-w-5xl mx-auto space-y-6">
      <div>
        ...
        <div className="flex items-center gap-4 mt-4">
          ...
          <h1 className="section-title text-gradient">Edit Payment</h1>
        </div>
        <p className="muted text-sm">Update payment information</p>
      </div>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
        <div className="card p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              <Input label="Amount (DH)" type="number" step="0.01" {...register("amount", { valueAsNumber: true })} />
